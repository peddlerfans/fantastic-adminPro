...
async function fetchUserStatistics() {
  ...
  const res = await testApi.userStatistics({ startDate, endDate })
  total.value = res.data.totalUsers
  today.value = res.data.totalNewUsersToday
  chartData.value = res.data.dailyNewTotalUsersList || []
  option.value = {
    type: 'line',
