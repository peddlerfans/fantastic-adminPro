...
const props = withDefaults(defineProps<StaticImageProps | URLPreviewProps>(), {
  isStatic: false,
  imageSrc: '',
  url: '',
  width: 200,
...
<template>
  <div :class="cn('relative inline-block', props.class)">
    ...
    <a
      :href="url"
      target="_blank"
      :class="cn('text-primary', props.linkClass)"
    ...
    <div
      v-if="isVisible"
      ref="preview"
      class="pointer-events-none absolute z-2050"
      :style="previewStyle"
    >
      <div
      ...
      >
        <div class="block border-2 border-transparent rounded-xl bg-white p-1 shadow-lg dark:bg-gray-900">
          <img
            :src="previewSrc"
            :width="width"
            :height="height"
